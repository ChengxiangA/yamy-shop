...
import com.yamy.shop.bean.model.*;
import com.yamy.shop.common.exception.YamyShopBindException;
import com.yamy.shop.dao.TranscityMapper;
import com.yamy.shop.dao.TransfeeFreeMapper;
import com.yamy.shop.dao.TransfeeMapper;
import com.yamy.shop.dao.TransportMapper;
    ...
    private void insertTransfeeFreeAndTranscityFree(Transport transport) {
        ...
        for (TransfeeFree transfeeFree : transfeeFrees) {
            ...
            if (CollectionUtil.isEmpty(cityList)) {
                throw new YamyShopBindException("请选择指定包邮城市");
            }
            // 当地址不为空时
